...
): RewardedAdState = rememberAdmobRewardedInterstitialAd(
...
/**
 * Creates and remembers an [AdmobRewardedInterstitialAd] instance and binds
 * it to the Compose lifecycle.
 */
@Composable
fun rememberAdmobRewardedInterstitialAd(
    adUnitId: String,
