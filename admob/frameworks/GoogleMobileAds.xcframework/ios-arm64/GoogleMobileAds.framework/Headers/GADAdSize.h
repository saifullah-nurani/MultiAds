...
/// views.
FOUNDATION_EXPORT GADAdSize GADPortraitInlineAdaptiveBannerAdWithWidth(CGFloat width)
...
/// by the banner's intrinsicContentSize. This ad size is most suitable for ads intended for scroll
/// views.
FOUNDATION_EXPORT GADAdSize GADLandscapeInlineAdaptiveBannerAdWithWidth(CGFloat width)
...
/// function to return GADPortraitInlineAdaptiveBannerAdWithWidth or
/// GADLandscapeInlineAdaptiveBannerAdWithWidth based on the current interface orientation.
/// This function must be called on the main queue.
FOUNDATION_EXPORT GADAdSize GADCurrentOrientationInlineAdaptiveBannerAdWithWidth(CGFloat width)
...
FOUNDATION_EXPORT GADAdSize GADInlineAdaptiveBannerAdWithWidthAndMaxHeight(CGFloat width,
                                                                               CGFloat maxHeight)
...
/// This function must be called on the main queue.
FOUNDATION_EXPORT GADAdSize GADLargePortraitAnchoredAdaptiveBannerAdWithWidth(CGFloat width)
...
/// 50-150 points. This function always returns the same height for any width / device combination.
/// This function must be called on the main queue.
FOUNDATION_EXPORT GADAdSize GADLargeLandscapeAnchoredAdaptiveBannerAdWithWidth(CGFloat width)
...
/// function to return GADLargePortraitAnchoredAdaptiveBannerAdWithWidth or
/// GADLargeLandscapeAnchoredAdaptiveBannerAdWithWidth based on the current interface
/// orientation. This function must be called on the main queue.
FOUNDATION_EXPORT GADAdSize GADLargeAnchoredAdaptiveBannerAdWithWidth(CGFloat width)
...
FOUNDATION_EXPORT GADAdSize const kGADAdSizeSmartBannerPortrait
    GAD_DEPRECATED_MSG_REPLACEMENT_ATTRIBUTE(
        "Use GADLargePortraitAnchoredAdaptiveBannerAdWithWidth instead.",
        GADLargePortraitAnchoredAdaptiveBannerAdWithWidth());
...
FOUNDATION_EXPORT GADAdSize const kGADAdSizeSmartBannerLandscape
    GAD_DEPRECATED_MSG_REPLACEMENT_ATTRIBUTE(
        "Use GADLargeLandscapeAnchoredAdaptiveBannerAdWithWidth instead.",
        GADLargeLandscapeAnchoredAdaptiveBannerAdWithWidth());
...
FOUNDATION_EXPORT GADAdSize GADPortraitAnchoredAdaptiveBannerAdWithWidth(CGFloat width)
...
FOUNDATION_EXPORT GADAdSize GADLandscapeAnchoredAdaptiveBannerAdWithWidth(CGFloat width)
    NS_SWIFT_NAME(landscapeAnchoredAdaptiveBanner(width:)) GAD_DEPRECATED_MSG_REPLACEMENT_ATTRIBUTE(
        "Use GADLargeLandscapeAnchoredAdaptiveBannerAdWithWidth instead.",
        GADLargeLandscapeAnchoredAdaptiveBannerAdWithWidth);

/// Returns a GADAdSize with the given width and a Google-optimized height. This is a convenience
/// function to return GADPortraitAnchoredAdaptiveBannerAdWithWidth or
/// GADLandscapeAnchoredAdaptiveBannerAdWithWidth based on the current interface orientation.
/// This function must be called on the main queue.
FOUNDATION_EXPORT GADAdSize
GADCurrentOrientationAnchoredAdaptiveBannerAdWithWidth(CGFloat width)
    NS_SWIFT_NAME(currentOrientationAnchoredAdaptiveBanner(width:))
        GAD_DEPRECATED_MSG_REPLACEMENT_ATTRIBUTE(
            "Use GADLargeAnchoredAdaptiveBannerAdWithWidth instead.",
            GADLargeAnchoredAdaptiveBannerAdWithWidth);
