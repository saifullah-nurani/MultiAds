...
import io.github.saifullah.nurani.ads.pangle.RewardedAdState
...
/**
 * Remembers and manages the lifecycle of a Pangle rewarded ad.
 *
 ...
 */
@Composable
actual fun rememberPangleRewardedAd(
...
): RewardedAdState = rememberPangleRewardedAd(
...
/**
 * Creates and remembers a [PangleRewardedAd] instance and binds
 * it to the Compose lifecycle.
 */
@Composable
fun rememberPangleRewardedAd(
    adUnitId: String,
