...
class PangleAppOpenAd(
    ...
    private val appOpenAdLoadListener = object : PAGAppOpenAdLoadListener {
        ...
        override fun onAdLoaded(appOpenAd: PAGAppOpenAd) {
    ...
    override fun onAdLoad() {
        ...
        PAGAppOpenAd.loadAd(finalAdUnitId, request, appOpenAdLoadListener)
    }
    ...
    companion object {
        @JvmStatic
        fun with(context: Context, adUnitId: String): PangleAppOpenAd {
            return PangleAppOpenAd(context, adUnitId, null, null)
        }

        @JvmStatic
        fun with(context: Context, @StringRes adUnitIdRes: Int): PangleAppOpenAd {
