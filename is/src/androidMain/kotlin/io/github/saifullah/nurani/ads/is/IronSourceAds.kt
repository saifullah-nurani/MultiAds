...
actual object IronSourceAds {
    ...
    @JvmStatic
    actual fun init(context: io.github.saifullah.nurani.ads.core.compose.PlatformContext, appKey: String, onComplete: ((Boolean) -> Unit)?) {
        init(context as Context, appKey)
