Pod::Spec.new do |spec|
    ...
    spec.libraries                = 'c++'
    if !Dir.exist?('build/cocoapods/framework/coreKit.framework') || Dir.empty?('build/cocoapods/framework/coreKit.framework')
        raise "
        Kotlin framework 'coreKit' doesn't exist yet, so a proper Xcode project can't be generated.
