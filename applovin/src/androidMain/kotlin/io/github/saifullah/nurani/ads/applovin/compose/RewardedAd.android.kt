...
/**
 * Remembers and manages the lifecycle of an AppLovin rewarded ad.
 */
@Composable
...
): RewardedAdState = rememberAppLovinRewardedAd(
...
/**
 * Creates and remembers a [AppLovinRewardedAd] instance and binds
 * it to the Compose lifecycle.
 */
@Composable
fun rememberAppLovinRewardedAd(
    adUnitId: String,
