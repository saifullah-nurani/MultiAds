 ...
 */
@Composable
actual fun rememberInMobiInterstitialAd(
...
): FullScreenAdState = rememberInMobiInterstitialAd(
...
/**
 * Creates and remembers a [InMobiInterstitialAd] instance and binds
 * it to the Compose lifecycle.
 */
@Composable
fun rememberInMobiInterstitialAd(
    placementId: Long,
    tag: String? = null,
