...
import io.github.saifullah.nurani.ads.inmobi.RewardedAdState
...
/**
 * Remembers and manages the lifecycle of an InMobi rewarded ad.
 */
@Composable
actual fun rememberInMobiRewardedAd(
...
): RewardedAdState = rememberInMobiRewardedAd(
...
/**
 * Creates and remembers a [InMobiRewardedAd] instance and binds
 * it to the Compose lifecycle.
 */
@Composable
fun rememberInMobiRewardedAd(
    placementId: Long,
