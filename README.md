...
sourceSets {
    commonMain.dependencies {
        ...
        implementation("io.github.saifullah-nurani.ads:multi-ads:1.1.0")
        
        // Standalone Modules
        // implementation("io.github.saifullah-nurani.ads:core:1.1.0")
        // implementation("io.github.saifullah-nurani.ads:admob:1.1.0")
        // implementation("io.github.saifullah-nurani.ads:applovin:1.1.0")
        // implementation("io.github.saifullah-nurani.ads:pangle:1.1.0")
        // implementation("io.github.saifullah-nurani.ads:vungle:1.1.0")
        // implementation("io.github.saifullah-nurani.ads:inmobi:1.1.0")
        // implementation("io.github.saifullah-nurani.ads:is:1.1.0")
    }
}
```
...
```kotlin
dependencies {
    implementation("io.github.saifullah-nurani.ads:multi-ads-android:1.1.0")
    
    // Standalone Modules
    // implementation("io.github.saifullah-nurani.ads:core-android:1.1.0")
    // implementation("io.github.saifullah-nurani.ads:admob-android:1.1.0")
    // implementation("io.github.saifullah-nurani.ads:applovin-android:1.1.0")
    // implementation("io.github.saifullah-nurani.ads:pangle-android:1.1.0")
    // implementation("io.github.saifullah-nurani.ads:vungle-android:1.1.0")
    // implementation("io.github.saifullah-nurani.ads:inmobi-android:1.1.0")
    // implementation("io.github.saifullah-nurani.ads:is-android:1.1.0")
}
```

### 3. iOS Setup (CocoaPods)
```ruby
pod 'MultiAdsMulti', '~> 1.1.0'
# pod 'MultiAdsAdmob', '~> 1.1.0'
```
