...
/**
 * Remembers and manages the lifecycle of a Meta interstitial ad.
 */
@Composable
...
): MetaFullScreenAdState = rememberMetaInterstitialAd(
...
/**
 * Creates and remembers a [MetaInterstitialAd] instance and binds
 * it to the Compose lifecycle.
 */
@Composable
fun rememberMetaInterstitialAd(
    placementId: String,
